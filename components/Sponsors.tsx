        ...
        <div className="max-w-[1120px] mx-auto px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-12 md:gap-32">
                <div className="group cursor-default">
                    <h3 className="text-2xl md:text-4xl font-black text-white tracking-tighter group-hover:text-primary transition-colors duration-300">
                        VASUDEV AI
                    </h3>
                </div>
                <div className="h-8 w-px bg-white/10 hidden md:block"></div>
                <div className="group cursor-default">
                    <h3 className="text-2xl md:text-4xl font-black text-white tracking-tighter group-hover:text-amber-500 transition-colors duration-300">
                        UTSAVY
                    </h3>
                </div>
            </div>
